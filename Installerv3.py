...
=================================================
echo $white"Author : radiv-jawsec / Div007"
echo $white"Team : BLACK CODERS ANONYMOUS"
echo $white"Youtube : Catatan Cyber"
...
echo  $red" 15) Exit "
echo  $white""
read -p "radiv-jawsec || Pilih Nomer> " bro;
...
echo  $red" Masukkan Kode Itu Ke Top Up Kalian ^_^"
exit
fi
...
echo  $red" Apabila Ingin Lanjut Tunggu Update an Selanjutnya"
exit
fi

if [ $bro = 15 ] || [ $bro = 15 ]
then
echo " Thanks To BLACK CODERS ANONYMOUS"
sleep 1
echo " radiv-jawsec"
sleep 1
echo " Bye-bye "
...
echo " Para Hacker "
sleep 1
echo " Jangan Lupa Sholat Terus Ngehek Yahh "
sleep 1
echo " Semoga Lu Besok Masuk Surga ea Budjank"
sleep 1
exit
fi
